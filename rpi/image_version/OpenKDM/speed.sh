...
ANSWER=`yad --title "OpenKDM" --window-icon=/home/pi/Desktop/OpenKDM/128.png --width=300 --height=300 --center \
...
case $exval in
   0) 
	...
	sed "/int speed_rpm/c\int speed_rpm=$ANSWER;" /home/pi/Desktop/OpenKDM/speed_control/speed_control.ino -i
	...
	arduino-cli upload --port /dev/ttyACM1 --fqbn arduino:avr:uno /home/pi/Desktop/OpenKDM/speed_control/
